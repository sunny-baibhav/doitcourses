    ...
    <div className="container box">
      ...
      <div className="wrap-v-regular">
        <div className="w-layout-grid grid-two-column flip">
          <div
            id="w-node-_34664643-b433-4f50-0510-31a888b5359b-194faa41"
          ...
          <div
            id="w-node-_34664643-b433-4f50-0510-31a888b5359e-194faa41"
          ...
          >
            ...
            <a
              data-wf-native-id-path="34664643-b433-4f50-0510-31a888b535a3"
              data-wf-ao-click-engagement-tracking="true"
              data-wf-element-id="34664643-b433-4f50-0510-31a888b535a3"
        ...
        <div className="w-layout-grid grid-two-column">
          <div className="wrap-v-large max-width-grid">
            ...
            <p>
              Access thousands of pre-edited reels and TikToks—from luxury
              montages to motivational content—all optimised for reach and speed.
              Just download, post, and watch your social metrics climb.
            </p>
            <a
              data-wf-native-id-path="34664643-b433-4f50-0510-31a888b535ad"
              data-wf-ao-click-engagement-tracking="true"
              data-wf-element-id="34664643-b433-4f50-0510-31a888b535ad"
              href="https://start.dropcourse.com/b/3cI9AU5SW9Gi2qu9Mi6oo04"
              data-wf-event-ids={157035618}
              className="button-secondary white w-inline-block"
              rel="noopener"
          ...
          <div
            id="w-node-_34664643-b433-4f50-0510-31a888b535b1-194faa41"
            className="content-card-b"
          >
            <div className="outline-div green">
              <img
                ...
                loading="lazy"
                sizes="(max-width: 2666px) 100vw, 2666px"
