    ...
    <div className="wrap-v-regular align-center margin-large">
      ...
      >
        <div className="wrap-h-x-small">
          <p className="max-width-badge products">1-Click Affiliate</p>
        </div>
      </a>
      <h1 style={{ color: "#f649ff" }} className="h1-max-width products">
        <span className="white">White-label and resell this</span>{" "}
        <span className="products-highlight-premium">premium </span>
        <span
          data-product-summary="affiliate course"
      ...
      <p className="paragraph-large hero products">
        ...
        <span data-product-name="1-Click Affiliate" className="products-name">
          1-Click Affiliate
        </span>{" "}
      ...
      <div className="header-button-group">
        ...
        >
          ...
          <div>
            Duplicate{" "}
            <span
              data-product-name="1-Click Affiliate"
  ...
  <div className="container box clear white">
    <div className="wrap-v-small margin-small">
      <div className="wrap-h-regular-2 mobile">
        ...
        <img
          src="https://cdn.prod.website-files.com/68369353418c3898194fa9f5/683858a3133436aac06c2604_1click.png"
          loading="lazy"
          alt=""
          height={40}
          sizes="100vw"
          srcSet="https://cdn.prod.website-files.com/68369353418c3898194fa9f5/683858a3133436aac06c2604_1click-p-500.png 500w, https://cdn.prod.website-files.com/68369353418c3898194fa9f5/683858a3133436aac06c2604_1click.png 538w"
          className="h3-image course"
        />
      </div>
      <div className="wrap-h-small course-stats">
        <p className="align-centre">155</p>
        <p>Lessons</p>
        <div className="dot white" />
        <p className="align-centre">21</p>
        <p>Modules</p>
        <div className="dot white" />
        <p className="align-centre">12.5</p>
